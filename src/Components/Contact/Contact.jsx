...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f500b9d1-cfba-494e-8341-c9fc4a0b5519");
    ...
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                ...
                <li><img src={location_icon} alt="" />77 Massaachusetts Ave, Cambridge<br/>MA 02139, United States</li>
            </ul>
        </div>
        <div className="contact-col">
